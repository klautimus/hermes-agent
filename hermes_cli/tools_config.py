...
CONFIGURABLE_TOOLSETS = [
    ...
    ("advisor",          "🧠 Strategic Advisor (Brain)",    "does ALL thinking — planning, architecture, design, debugging, decisions. You execute."),
]
...
# Advisor (secondary strategic model) is opt-in via `hermes tools enable advisor`.
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "spotify", "discord", "discord_admin", "video", "video_gen", "x_search", "a2a", "advisor"}
